use crate::{
    blas::libopenblas::{
        cblas_dsdot, cblas_isamax, cblas_isamin, cblas_sasum, cblas_saxpy, cblas_scopy, cblas_sdot,
        cblas_sdsdot, cblas_snrm2, cblas_srot, cblas_srotg, cblas_srotm, cblas_srotmg, cblas_sscal,
        cblas_sswap,
    },
    vector::Vector,
};
