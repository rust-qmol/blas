use crate::{
    blas::libopenblas::{
        cblas_dasum, cblas_daxpy, cblas_dcopy, cblas_ddot, cblas_dnrm2, cblas_drot, cblas_drotg,
        cblas_drotm, cblas_drotmg, cblas_dscal, cblas_dswap, cblas_idamax, cblas_idamin,
    },
    vector::Vector,
};
