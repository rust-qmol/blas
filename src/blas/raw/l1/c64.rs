...
use crate::blas::libopenblas::{
    blasint, cblas_dzasum, cblas_dznrm2, cblas_icamax, cblas_icamin, cblas_zaxpy, cblas_zcopy,
    cblas_zdotc_sub, cblas_zdotu_sub, cblas_zdrot, cblas_zrotg, cblas_zscal, cblas_zswap,
};

use super::{BlasLevel1ComplexRaw, BlasLevel1Raw};

impl BlasLevel1Raw for Complex<f64> {
    type Pointer = c_void;
    type Coeff = f64;
...
impl BlasLevel1ComplexRaw for Complex<f64> {
    unsafe fn dotc_sub(
        n: blasint,
        x: *const Self::Pointer,
        incx: blasint,
